                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) => Padding(
                        ...
                        child: InkWell(
                                ...
                                children: [
                                  ...
                                  Row(children: [
                                    ...
                                    SizedBox(
                                        width: Get.width / 2,
                                        child: Text(
                                            Alltest[index]['test_obtaine_mark']
                                                    .toString() ??
                                                "",
                                            style: const TextStyle(
                                                color: Colors.blue,
                          ...
                          onTap: () {
                            var deta = {
                              "user": getdata.read('logindata')['Result']['user_name'],
                              "examname":
                                  Alltest[index]['tests_name'].toString(),
                              "total": Alltest[index]['tests_marks'].toString(),
                              "obtained": Alltest[index]['test_obtaine_mark']
                                  .toString(),
                              "date":
                                  Alltest[index]['test_curt_time'].toString(),
                            };
                            setState(() {});
                            save('TestID',
